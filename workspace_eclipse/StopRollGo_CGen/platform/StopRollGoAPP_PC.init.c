...
static void initClass_ROOT_StopRollGoAPP_PC(ROOT_StopRollGoAPP_PC_Class *self)
{
    self->ASCET_TOP_Ptr = (struct L1_StopRollGoAPP_PC_Obj*) initInstance_L1_StopRollGoAPP_PC();
}

static ASDClassHeader ROOT_ClassHeader_StopRollGoAPP_PC = {0, 0, 0, 1, (MethodList *)0, (MethodList *)0};
static ROOT_StopRollGoAPP_PC_Class ROOT_StopRollGoAPP_PC_ClassObj = {{1, {&ROOT_ClassHeader_StopRollGoAPP_PC}, {0}}};

/* Initialization from root node of model */
ASDObject *initializeRoot_StopRollGoAPP_PC(void)
{
	struct ROOT_StopRollGoAPP_PC_Obj *self = 0;

	initClass_ROOT_StopRollGoAPP_PC(&ROOT_StopRollGoAPP_PC_ClassObj);
	CREATE_OBJECT(self, ROOT_StopRollGoAPP_PC);
...
{
    return initializeRoot_StopRollGoAPP_PC();
}
