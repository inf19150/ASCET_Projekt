...
writes TrafficLightMessages.flashed, TrafficLightMessages.visibleProximity {
	...
	@thread
	@generated("blockdiagram", "58717ac9")
	public void calc() {
		...
		TrafficLight_instance_1.setYellow(TrafficLightMessages.yellow); // Main/calc 4
		...
		TrafficLight_instance_1.setGreen(TrafficLightMessages.green); // Main/calc 7
		...
		TrafficLight_instance_1.updateProximity(CarMessages.dist); // Main/calc 10
		...
		if (TrafficLight_instance_1.getVisible()) {
			TrafficLightMessages.visibleProximity = TrafficLight_instance_1.getProximity(); // Main/calc 14/if-then 1
		} // Main/calc 14
		...
		TrafficLightMessages.flashed = FlashLight.calc(TrafficLight_instance_1.getProximity(), TrafficLight_instance_2.getProximity(), TrafficLight_instance_3.getProximity(), TrafficLightMessages.red); // Main/calc 17
	}
}